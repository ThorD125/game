...
function Character:init(sprite_image, sprite_x_amount, sprite_y_amount, up, down, left, right, speed, positions)
...
function Character:render()
    self.sprite:render(self.positions[self.movement.facing]["still"])
    -- self.health:render()
end